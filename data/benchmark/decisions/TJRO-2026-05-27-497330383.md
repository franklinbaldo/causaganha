...
court: TJRO
decision_reasoning: The judge initiated the lawsuit by ordering the defendant's citation,
  outlining the procedural steps for defense and potential conciliation, and specifying
  the requirements for requesting oral evidence.
decision_type: decisão interlocutória
fase_processual: unknown
intimation_id: 497330383
is_human_verified: false
judge_name: Alex Balmant
keywords:
- seguro
- citação
- contestação
...
summary: The court orders the defendant insurance company to be cited to present a
  defense within 15 days, informing them about the possibility of conciliation and
  the procedure for requesting oral evidence.
text_uuid: on1OxBm76EJt2yCaTpdaAoZ3revpEj
validated_at: '2026-05-27T23:50:03.614929'
valor_causa: 33493.0
