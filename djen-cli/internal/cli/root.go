...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "djen-pp-cli",
		Short: "Manage djen resources via the djen API",
		Long: `Manage djen resources via the djen API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'djen-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("djen-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'djen-pp-cli profile list')")
	...
	rootCmd.AddCommand(newComunicacaoCmd(flags))
	...
	rootCmd.AddCommand(newCadernoPromotedCmd(flags))
