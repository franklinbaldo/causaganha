...
class VoteManager:
    ...
    def cast_vote(self, voter_sequence: str, candidate_personas: list[str]) -> None:
        ...
        if self.votes_file.exists():
            with open(self.votes_file, newline="") as f:
    ...
    def _is_sequence_executed(self, sequence_id: str) -> bool:
        ...
        with open(self.schedule_file, newline="") as f:
            reader = csv.DictReader(f)
            for row in reader:
    ...
    def get_next_open_sequence(self) -> str | None:
    ...
    def apply_votes(self, sequence_id: str) -> str | None:
    ...
    def get_current_sequence(self, persona_id: str) -> str | None:
    ...
    def _get_scheduled_persona(self, sequence_id: str) -> str | None:
