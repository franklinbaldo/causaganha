...
async def test_ingest_worker_success(
    ...
    # Called with positional args: (file_path, item_id, metadata)
    assert args[1] == "causaganha-test_doc_key"  # item_id
    assert args[2]["url"] == "http://court.gov.br/doc.pdf"  # metadata
