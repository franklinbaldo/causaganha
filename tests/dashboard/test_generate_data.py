...
def test_fetch_kilo_ready_count_all_success(mock_urlopen):
...
@patch("urllib.request.urlopen")
def test_fetch_kilo_ready_count_with_failures(mock_urlopen):
...
@patch("urllib.request.urlopen")
def test_fetch_kilo_ready_count_pending_checks(mock_urlopen):
...
@patch("urllib.request.urlopen")
def test_fetch_kilo_ready_count_empty_checks(mock_urlopen):
...
@patch("urllib.request.urlopen")
def test_fetch_kilo_ready_count_kilo_success(mock_urlopen):
