...
class TestUploadFileValidation:
    ...
    @pytest.mark.asyncio
    async def test_validates_item_id_format(
        self, ia_service: InternetArchiveService, temp_file: Path
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_validates_file_size_reasonable(
        self, ia_service: InternetArchiveService, tmp_path: Path
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_validates_metadata_structure(
        self, ia_service: InternetArchiveService, temp_file: Path
    ) -> None:
...
class TestUploadResilience:
    ...
    @pytest.mark.asyncio
    async def test_logs_upload_progress(
        self, ia_service: InternetArchiveService, temp_file: Path
    ) -> None:
...
class TestCheckItemExists:
    ...
    @pytest.mark.asyncio
    async def test_returns_false_for_nonexistent_item(
        self, ia_service: InternetArchiveService
    ) -> None:
...
class TestMetadataGeneration:
    ...
    def test_generates_valid_metadata_from_intimation(
        self, ia_service: InternetArchiveService
    ) -> None:
...
class TestLocalArchiveHierarchicalStorage:
    ...
    @pytest.mark.asyncio
    async def test_uses_hierarchical_path_with_metadata(
        self, local_service: LocalArchiveService, temp_file: Path
    ) -> None:
        ...
        expected_path = (
            local_service.archive_root / "TJRO" / "2024" / "05" / item_id / temp_file.name
        )
    ...
    @pytest.mark.asyncio
    async def test_fallback_to_flat_if_metadata_missing(
        self, local_service: LocalArchiveService, temp_file: Path
    ) -> None:
