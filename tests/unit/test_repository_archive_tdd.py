"""Comprehensive tests for repository archive functionality (TDD approach)."""
...
class TestGetUnarchivedIntimations:
    """Test suite for get_unarchived_intimations (TDD)."""
...
class TestMarkAsArchived:
    """Test suite for mark_as_archived (TDD)."""
    ...
    async def test_validates_ia_url_format(self, repository, mock_connection):
        ...
        # This test defines behavior we SHOULD have
        # Act & Assert
...
class TestRepositoryIntegration:
    """Integration tests for repository operations (TDD)."""
