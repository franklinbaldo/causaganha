...
- **Prova concluída após a fila avançar:** o relatório público passou a informar geração em `2026-09-11T17:24:43+00:00`, com 43 Parquets DJEN. A consulta ao índice público retornou cinco registros do CNJ `70083321620268220007`, todos apontando para `djen-tjro-2026/comunicacoes.parquet`. A homepage local em `localhost:4321/causaganha`, usando os arquivos públicos pelo transporte de leitura, exibiu **5 publicações**, tribunal **TJRO**, primeira em **2026-07-08** e última em **2026-09-04**. A primeira leitura do Parquet de origem recebeu um 404 transitório; a repetição concluiu sem esse aviso. A leitura inicial ainda é lenta. Essa prova valida a integração de dados nessa página local; não comprova implantação do transporte de leitura em produção nem conclusão do backlog nacional.
