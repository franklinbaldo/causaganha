...
To advance the segmenter to v7, we have developed new infrastructure and updated our ontology (now at 25 classes). To fully leverage these improvements, we need a pristine gold dataset.
...
1.  **Salvage v7 Infrastructure**: We will retain the modern v7 infrastructure, scripts, tests, and configurations (e.g., sampler logic, region reconstruction, regex pre-pass, OPF annotation helpers, and the 25-class label space) developed in earlier iterations.
