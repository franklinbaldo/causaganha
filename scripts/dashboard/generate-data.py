    ...
    if run_stats_path.exists():
        try:
            ...
            if runs:
                ...
                perf_metrics["causaganha_recent_failure_rate"] = recent_failure_stats.get(
                    "recent_failure_rate"
                )
                perf_metrics["causaganha_recent_failed_count"] = recent_failure_stats.get(
                    "recent_failed_count"
                )
                perf_metrics["causaganha_recent_window_size"] = recent_failure_stats.get(
                    "recent_window_size"
                )
                perf_metrics["causaganha_latest_failed_run_url"] = recent_failure_stats.get(
