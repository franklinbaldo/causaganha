...
class TestGeminiExtractor(unittest.TestCase):
    ...
    def test_extract_with_api_key_and_genai_success(self, mock_genai):
        ...
        mock_gemini_response.text = json.dumps(
            {
                ...
                "partes": {
                    "requerente": ["Teste Requerente"],
                    "requerido": ["Teste Requerido"],
                },
                "advogados": {
                    "requerente": ["Adv Teste (OAB/UF 987)"],
                    "requerido": ["Adv Teste2 (OAB/UF 654)"],
                },
        ...
        self.assertTrue(
            extractor.gemini_configured
        )  # Check if configuration was attempted and deemed successful
    ...
    @patch(
        "causaganha.core.extractor.genai", None
    )  # Simulate genai not being importable
    ...
    def test_api_call_failure_generate_content(self, mock_genai):
        ...
        mock_genai.delete_file.assert_called_once_with(
