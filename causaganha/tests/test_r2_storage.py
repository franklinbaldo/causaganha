...
class TestCloudflareR2Storage:
    ...
    def test_ensure_bucket_exists(self, mock_boto3, mock_config):
        ...
        mock_s3_client.head_bucket.assert_called_once_with(Bucket=mock_config.bucket_name)
    ...
    def test_ensure_bucket_creates_if_missing(self, mock_boto3, mock_config):
        ...
        assert result is True
        mock_s3_client.create_bucket.assert_called_once_with(Bucket=mock_config.bucket_name)
    ...
    def test_create_duckdb_snapshot(self, mock_db_class, mock_boto3, mock_config, temp_dir):
        """Test DuckDB snapshot creation."""
        # Mock database operations
        mock_db = Mock()
        mock_db.conn.execute.return_value = None
        mock_db.get_statistics.return_value = {'total_decisoes': 100, 'total_advogados': 50}
...
class TestR2DuckDBClient:
    ...
    def test_r2_client_initialization(self, mock_r2_storage, mock_duckdb_connect, mock_query_config):
    ...
    @patch('causaganha.core.r2_queries.duckdb.connect')
    @patch('causaganha.core.r2_queries.CloudflareR2Storage')
    def test_get_snapshot_s3_url(self, mock_r2_storage, mock_duckdb_connect, mock_query_config):
