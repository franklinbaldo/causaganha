...
from causaganha.core.archive_db import DatabaseArchiver, IAConfig
    ...
    def test_ia_config_from_env_missing_keys(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            with self.assertRaises(ValueError) as context:
                IAConfig.from_env()
            self.assertIn("Missing required IA environment variables", str(context.exception))
    ...
    def test_export_database_snapshot(self, mock_db_class):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('pandas.DataFrame') as mock_df_class:
                ...
                exports = archiver.export_database_snapshot(db_path, export_dir, test_date)
