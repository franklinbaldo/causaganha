...
- [x] **Verify & Test V2 Pipelines**
    - [x] Create `tests/v2/integration/test_pipeline_archive.py`
    - [x] Create `tests/v2/e2e/test_cli.py` to verify CLI commands
    - [x] Create `tests/v2/e2e/test_full_lifecycle.py` to verify full V2 flow
    - [x] Ensure all tests pass with `uv run pytest tests/v2/`
