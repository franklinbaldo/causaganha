...
rationale: "1470's audit is unblocked, small, and directly closes an outstanding checklist item with fresh evidence; #1469/#1482/#950 were also investigated this round and found to have zero remaining code work (only credential-gated deployment/publication left), so they are not better picks; #1594 is another session's in-flight work and touching it risks a merge race."
---
