...
only leaving tooling behind for a future round. #1678 squash-merged to
main directly (sha `9d39b73`); its sibling closeout PR #1679 (pure
`knowledge/agent-runs/` bookkeeping confirming a concurrent session had
already reconciled #1678) was closed without merging per the repo's
anti-ceremonial-PR rule.
