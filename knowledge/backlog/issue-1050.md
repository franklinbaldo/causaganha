...
last_verified_run_id: "wisk:20260920T002530Z-do-the-best-useful-work-available-in-this-reposi"
last_verified_at: "2026-09-20T01:35:00Z"
status: "unblocked"
---
...
antes de aceitar -- ver classe de risco 14 (reconfirmada). UPDATE (rodada Wisk 20260920T002530Z): a classe de risco 17 (label singleton descartado quando aninhado dentro do papel `<inicio>`/`<fim>` de um par) foi corrigida na propria causa raiz em `segmenter_dataset.store._text_element_to_labels` pela PR #1588 (RED->GREEN, `tests/segmenter_dataset/test_store.py::test_singleton_label_nested_inside_pair_role_survives_round_trip`), mesclada logo apos a PR #1586 (lote 23) que a descobriu. Lotes futuros nao precisam mais do workaround de reposicionar `<resultado>` como irmao de `<inicio>`/`<fim>` -- o parser agora recupera o label corretamente aninhado. document_count 173->179 apos o lote 23; ainda faltam ~3-4 lotes deste tamanho para alcancar o piso combinado de val/test>=30/30 da RFC 0012 Sec 5 item 4.
