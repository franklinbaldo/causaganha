...
command: "uv run okf-parser check knowledge --relational-schema okf.schema.sql  vs.  uv run python -c \"from okf_parser import load_bundle; print(load_bundle(Path('knowledge')).is_conformant)\""
result: "observed"
