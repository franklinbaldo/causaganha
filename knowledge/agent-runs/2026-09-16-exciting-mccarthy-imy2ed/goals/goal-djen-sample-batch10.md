...
goal: "Ingerir um decimo lote real de documentos DJEN nao usados (Sentenca/Acordao, categoria escassa 'preliminar') no corpus de treino do segmentador para a issue #1050, elevando document_count e o teto de val/test em scripts/segmenter_governance_status.py, sem colidir com a PR #1557 (nono lote, sessao concorrente, ainda aberta)."
rationale: "#1050 e a unica linhagem de trabalho genuinamente desbloqueada e valiosa disponivel hoje -- todo o resto do backlog (epics #1047/#1053, #950, #951, #985, #1022, #1482) esta bloqueado por GPU/humano-no-loop ou por credenciais ausentes (IA, Cloudflare), sem fato novo. #1051 (validation set independente) depende de #1050 cruzar o piso combinado de RFC 0012 Sec 5 item 4 (~200 documentos totais); document_count esta em 109 pre-lote10, ainda distante do piso. 'preliminar' continua a categoria mais escassa (21 instancias, contra >=10 exigido, mas a mais proxima do teto entre as 25 categorias)."
...
Alcancado: document_count 109->111, val_ceiling/test_ceiling 16/16->17/17,
suite completa verde. Ver `evidence/evidence-batch10-ingested.md`.
