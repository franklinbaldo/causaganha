...
**Alcancado**: document_count 132->138, val_ceiling/test_ceiling
20/20->21/21, alem de uma nova classe de risco (14: sub-anotacao com cue
de fechamento disponivel, distinta da classe ja documentada de par
pendente sem cue nenhuma) e uma correcao de defeito de HTML-entity
recorrente em TJGO (mesmo padrao do lote 12).
