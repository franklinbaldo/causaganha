...
description: "Added test_real_store_reflects_batch12_corpus_growth asserting document_count>=121 and presence of TJES/577054686 (hash 57ea4a68...) and TJGO/543562390 (hash b04a0802..., after html.unescape) document hashes. Ran uv run pytest tests/segmenter_dataset/test_segmenter_governance_status.py::test_real_store_reflects_batch12_corpus_growth -q: FAILED, AssertionError: assert 119 >= 121 -- confirms RED against the current store (119 documents, post-batch11-merge) before ingestion."
---
