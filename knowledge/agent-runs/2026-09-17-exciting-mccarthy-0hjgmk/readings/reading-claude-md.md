...
RFC 0012) continua fora do mapa de arquivos do CLAUDE.md, mas ainda sujeita
...
amplo fora de um bulkhead documentado por ADR. Nenhuma mudanca de producao
planejada para `djen_backup` ou `web` nesta rodada -- reuso do script de
ingestao ja existente (`scripts/ingest_djen_sample_technique1_batch.py`)
sem tocar em worker pools do djen_backup.
