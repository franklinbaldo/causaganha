#!/bin/bash
# ============================================================================
# DJEN PROXY - Security Tests (URL version)
# Usage: ./TEST_DJEN_SECURITY_URL.sh <URL>
# Example: ./TEST_DJEN_SECURITY_URL.sh https://djen-proxy-xxx.run.app
# ============================================================================
...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "Usage: $0 <URL>"
    echo "Example: $0 https://djen-proxy-xxx.run.app"
    echo ""
    exit 1
fi
