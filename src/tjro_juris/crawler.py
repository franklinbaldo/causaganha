...
def _extract_doc(raw: dict) -> dict:
    ...
    2026-07-14 field audit in #821. Deliberately excludes clearly
    redundant/low-value fields (``dtjulgamento_str`` duplicates
    ``dtjulgamento``, ``datarodape``/``cod_ini`` are display-only, etc).
    """
