...
class DecisionAnalysis(BaseModel):
    ...
    loser_lawyer_oab: str = Field(description="OAB registration number of the losing lawyer")
    loser_lawyer_state: str = Field(
        min_length=2, max_length=2, description="State code of loser's OAB registration",
    )
