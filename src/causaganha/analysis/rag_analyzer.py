...
OUTCOME_PHRASES = {
    "WIN": [
        ...
        "acolho integralmente o pedido",
        "dou integral provimento ao recurso",
        "dou provimento ao recurso do autor",
        "reforma-se a sentença para julgar procedente",
    ...
    "EXTINTO_SEM_MERITO": [
        ...
        "pronuncio a prescrição",
        "julgo extinto sem julgamento do mérito",
        "carência de ação",
