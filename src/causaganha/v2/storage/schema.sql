...
CREATE TABLE lawyer_ratings (
    ...
    -- Context
    tribunal VARCHAR(10) DEFAULT 'GLOBAL',  -- NULL for global rating, but using 'GLOBAL' string to avoid unique constraint issues with NULLs in DuckDB if needed, or simply handle NULLs. Plan says GLOBAL.
