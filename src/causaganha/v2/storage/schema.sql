...
CREATE TABLE IF NOT EXISTS lawyer_ratings (
    ...
    rating FLOAT GENERATED ALWAYS AS (mu - 3 * sigma),
...
CREATE INDEX IF NOT EXISTS idx_intimation_lawyers_oab
    ON intimation_lawyers(oab_number, oab_state);

CREATE INDEX IF NOT EXISTS idx_decision_winner
    ON decision_analysis(winner_lawyer_oab, winner_lawyer_state);

CREATE INDEX IF NOT EXISTS idx_decision_loser
...
CREATE INDEX IF NOT EXISTS idx_lawyer_ratings_global
