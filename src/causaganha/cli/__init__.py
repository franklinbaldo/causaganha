...
def collect(
    ...
    async def _run() -> None:
        try:
            ...
            handle_error(e, "Collection failed")
...
def analyze(
    ...
    async def _run() -> None:
        try:
            ...
            handle_error(e, "Analysis failed")
...
def db(action: str = typer.Argument(..., help="Action: init, status, migrate")) -> None:
    ...
    if action == "status":
        ...
        try:
            ...
            handle_error(e, "Initialization failed")
    elif action == "migrate":
        try:
            ...
            handle_error(e, "Migration failed")
    else:
...
def export_status(
    ...
    try:
        ...
        handle_error(e, "Failed to get export status")
...
def groundtruth_status() -> None:
    ...
    try:
        ...
        handle_error(e, "Failed to check ground truth status")
...
def groundtruth_init(
    ...
    try:
        ...
        handle_error(e, "Failed to initialize ground truth")
...
def groundtruth_info() -> None:
    ...
    try:
        ...
        handle_error(e, "Failed to get ground truth info")
...
def analyze_parquet_file(
    ...
    async def _run() -> None:
        try:
            ...
            handle_error(e, "Parquet analysis failed")
...
def analyze_from_ia(
    ...
    async def _run() -> None:
        try:
            ...
            handle_error(e, "Internet Archive analysis failed")
...
def clear_parquet_cache(
    ...
    try:
        ...
        handle_error(e, "Cache clear failed")
