...
class ResourceSpec:
    """One official Processual resource observed in the TSE catalog."""
...
PROCESSUAL_2026_RESOURCES = (
    ...
    ResourceSpec(
        ...
        url=(
            ...
            "processos_eleitorais_assuntos_2026.zip"
        ),
    ),
    ResourceSpec(
        kind=ResourceKind.DECISOES,
        year=2026,
        url=(
            "https://cdn.tse.jus.br/estatistica/sead/odsele/processual/"
            "processos_eleitorais_decisoes_2026.zip"
        ),
    ),
)
...
def resource_for(kind: ResourceKind, *, year: int = 2026) -> ResourceSpec:
    """Return the admitted resource, rejecting unsupported years explicitly."""
