"""Build the privacy filter training Colab notebook with correct UTF-8."""

import json
from pathlib import Path

BRANCH = "feat/embedder-smart-truncate-and-privacy-dataset"
IA_TEXTOS_URL = "https://archive.org/download/causaganha-test-parquets/textos.parquet"
...
nb = {
    ...
    "cells": [
        ...
        # --- Section 5 ---
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 5. 🏋️ Fine-tune BERTimbau"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
...
out = Path("notebooks/train_privacy_filter.ipynb")
