    ...
    "cells": [
        # --- Title ---
        {
            ...
            "source": [
                ...
                "2. Upload your parquet data files\n",
                "3. Preview data\n",
        ...
        # --- Section 2 ---
        {
            ...
            "source": [
                "## 2. 📂 Upload Data Files\n",
                "\n",
                "Upload the two parquet files from your local `data/test_parquets/` directory:\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "print(\"Upload 'classificacoes_documentos.parquet' and 'textos.parquet'\")\n",
                ...
                "        f.write(data)\n",
                "    print(f\"  ✅ Saved {fname} -> {dest} ({len(data):,} bytes)\")\n",
                "\n",
                "required = [\"classificacoes_documentos.parquet\", \"textos.parquet\"]\n",
                "for req in required:\n",
                "    path = os.path.join(PARQUET_DIR, req)\n",
